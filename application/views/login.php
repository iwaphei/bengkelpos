...
<div align="center" style="margin-top:10px"><img src=<?php echo base_url();?>/images/logobuz.png>
...
<?php echo form_close(); ?><h1>Wacky Buz - Business Solution <?php echo $this->config->item('application_version'); ?></h1>
</body>
</html>
