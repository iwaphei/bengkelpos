...
<?php
echo form_open('config/save_receipt/',array('id'=>'receipt_config_form','class'=>'form-horizontal'));
?>
...
<div class="row">
    <div class="col-md-8">
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_use_invoice_template').':', 'use_invoice_template',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-2'>
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_invoice_default_comments').':', 'invoice_default_comments',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-8'>
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_invoice_email_message').':', 'invoice_email_message',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-8'>
				<?php echo form_textarea(array(
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_receipt_show_taxes').':', 'receipt_show_taxes',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-2'>
				<div class="input-group">
                    <span class="input-group-addon">
                      	<?php echo form_checkbox(array(
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_show_total_discount').':', 'show_total_discount',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-2'>
				<div class="input-group">
                    <span class="input-group-addon">
                      	<?php echo form_checkbox(array(
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_print_silently').':', 'print_silently',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-2'>
				<div class="input-group">
                    <span class="input-group-addon">
                      	<?php echo form_checkbox(array(
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_print_header').':', 'print_header',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-2'>
				<div class="input-group">
                    <span class="input-group-addon">
                      	<?php echo form_checkbox(array(
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_print_footer').':', 'print_footer',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-2'>
				<div class="input-group">
                    <span class="input-group-addon">
                      	<?php echo form_checkbox(array(
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_receipt_printer').':', 'config_receipt_printer',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-8'>
		...
		<div class="form-group">
			<?php echo form_label($this->lang->line('config_invoice_printer').':', 'config_invoice_printer',array('class'=>'col-sm-4 text-left')); ?>
			<div class='col-sm-8'>
		...
		<div class="form-group">
            <?php echo form_label($this->lang->line('config_print_top_margin').':', 'print_top_margin',array('class'=>'col-sm-4 text-left required')); ?>
            <div class='col-sm-8'>
        ...
        <div class="form-group">
            <?php echo form_label($this->lang->line('config_print_left_margin').':', 'print_left_margin',array('class'=>'col-sm-4 text-left required')); ?>
            <div class='col-sm-8'>
	            <?php echo form_input(array(
	            'type'=>'number',
		      	'min'=>'0',
        ...
        <div class="form-group">
            <?php echo form_label($this->lang->line('config_print_bottom_margin').':', 'print_bottom_margin',array('class'=>'col-sm-4 text-left required')); ?>
            <div class='col-sm-8'>
	            <?php echo form_input(array(
	            'type'=>'number',
		        'min'=>'0',
        ...
        <div class="form-group">
            <?php echo form_label($this->lang->line('config_print_right_margin').':', 'print_right_margin',array('class'=>'col-sm-4 text-left required')); ?>
            <div class='col-sm-8'>
	            <?php echo form_input(array(
	          	'type'=>'number',
		        'min'=>'0',
