...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	...
	const FORMAT_NUMBER_COMMA_SEPARATED_ME	= '#,##0';
	...
	const FORMAT_CURRENCY_IDR				= 'Rp#,##0_-';
	const FORMAT_CURRENCY_IDR_ACCOUNTING				= '_([$Rp-421]* #,##0_);_([$Rp-421]* (#,##0);_([$Rp-421]* "-"_);_(@_)';
	const FORMAT_CURRENCY_USD_ACCOUNTING				= '_($* #,##0.00_);_($* (#,##0.00);_($* "-"??_);_(@_)';
